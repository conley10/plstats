...
MODEL_FILE = (
    MODEL_DIR
    / "transfer_value_historical_baseline.joblib"
)
...
RESULTS_FILE = (
    ...
    / "data"
    / "processed"
    / "historical_baseline_predictions.csv"
)
...
GRAPH_FILE = (
    ...
    / "data"
    / "processed"
    / "historical_baseline_actual_vs_predicted.png"
)
...
def evaluate_model(
    ...
    print(
        "PLSTATS HISTORICAL-ONLY BASELINE"
    )
...
def main():
    ...
    print(
        "Training historical-only baseline..."
    )
